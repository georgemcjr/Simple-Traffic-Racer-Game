function Score() {
	...
	this.draw = function(context, pointsPar) {
		...
		Util.drawTextWithShadow(context, this.currentScore, 660, 90, "yellow", 2, 2, "red");

		Util.drawTextWithShadow(context, "HIGH", 660, 180, "white", 2, 2, "red");
		Util.drawTextWithShadow(context, "SCORE", 660, 210, "white", 2, 2, "red");

		Util.drawTextWithShadow(context, this.highScore, 660, 250, "yellow", 2, 2, "red");
	...
	this.drawGameOverScreen = function(context) {
		...
		Util.drawTextWithShadow(context, "GAME OVER", 250, 260, "red", 2, 2, "yellow");

		context.font="46px Arial";
		Util.drawTextWithShadow(context, "SCORE", 237, 320, "white", 2, 2, "red");
		Util.drawTextWithShadow(context, this.currentScore, 410, 320, "yellow", 2, 2, "red");
		
		context.font="30px Arial";

		Util.drawTextWithShadow(context, "HIGH SCORE", 210, 380, "white", 2, 2, "red");
		Util.drawTextWithShadow(context, this.highScore, 410, 380, "yellow", 2, 2, "red");
